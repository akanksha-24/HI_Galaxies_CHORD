...
#    SNRint_fromFile('catalogs_output/MockAlf_FullSky.npy', RMS=1, plt=False, maskFl='catalogs_output/maskRMS1_sigma6_MockAlf_FullSky.npy')
    detections_fromObs('catalogs_output/VolLim_20to80deg_zmax0p8_rank2.npy', obsyears=1, nstrips=20, chan_width_kms=5, 
                  maskFl='catalogs_output/Detected1yr_RMS0p18_VolLim_20to80deg_zmax0p8_chan5kms_rank2.npy')
