...
if __name__ == "__main__":
    Run_Spectra(catalog_fl='catalogs_output/VolLim_20to60deg_Dmax200_rank0.npy', size=1000, zmax=0.117, plot=False)
    #Run_Spectra(catalog_fl='../catalogs_output/VolLim_20to60deg_Dmax500.npy', size=1000, zmax=0.117, plot=False)
